...
export const ShareModal: React.FC<ShareModalProps> = ({
  ...
  const shareTargetInfo: Record<AppTab, {
    ...
    home: {
      ...
      descEn: 'DAE-registered 187+ pesticides, knapsack sprayer tank calculator, MoA rotation planner, WHO safety protocols & offline field manual.',
      descBn: 'বাংলাদেশে মাঠ ফসলের জন্য ডিএই নিবন্ধিত ১৮৭+ বালাইনাশক ডাটাবেস, স্প্রেয়ার ট্যাংক ক্যালকুলেটর, প্রতিরোধ রোধে MoA রোটেশন ও পকেট বুক।',
    ...
    database: {
      ...
      descEn: 'Search 187+ approved active ingredients, trade names, approved crops, and mode-of-action codes.',
      descBn: 'ফসল, বালাই, ট্রেড নাম ও MoA কোড দিয়ে ডিএই নিবন্ধিত ১৮৭+ বালাইনাশকের অনুমোদন তালিকা দেখুন।',
