      ...
      >
        ...
        <div className="p-6 space-y-5">
          ...
          <div className="rounded-xl border border-slate-200 bg-slate-50/80 p-3.5 space-y-2">
            ...
            <div className="bg-white rounded-lg border border-slate-200 p-3 shadow-2xs space-y-1.5">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5">
              ...
              <a
                ...
                className="flex items-center justify-center gap-2 py-2.5 px-3 rounded-xl bg-[#25D366]/10 hover:bg-[#25D366]/20 border border-[#25D366]/30 text-[#128C7E] font-semibold text-xs transition shadow-2xs"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center gap-2 py-2.5 px-3 rounded-xl bg-[#1877F2]/10 hover:bg-[#1877F2]/20 border border-[#1877F2]/30 text-[#1877F2] font-semibold text-xs transition shadow-2xs"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center gap-2 py-2.5 px-3 rounded-xl bg-slate-900/10 hover:bg-slate-900/20 border border-slate-300 text-slate-900 font-semibold text-xs transition shadow-2xs"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center gap-2 py-2.5 px-3 rounded-xl bg-[#229ED9]/10 hover:bg-[#229ED9]/20 border border-[#229ED9]/30 text-[#0088cc] font-semibold text-xs transition shadow-2xs"
              >
